...
export default function SolarFinderPage() {
  ...
  if (step === "done") {
    return (
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <div className="mb-6"><span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 64, color: "#f59e0b" }}>celebration</span></div>
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-10">
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-amber-100 border border-amber-200 text-spark-amber text-sm font-semibold">
            <span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 16, verticalAlign: "middle", marginRight: 4 }}>wb_sunny</span>Almost there
          </div>
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-amber-100 border border-amber-200 text-spark-amber text-sm font-semibold">
            <span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 16, verticalAlign: "middle", marginRight: 4 }}>wb_sunny</span>{installers.length} installer{installers.length !== 1 ? "s" : ""} near {prefs.zip}
          </div>
        ...
        {installers.length === 0 ? (
          <div className="text-center py-12 bg-surface rounded-2xl border border-black/6 shadow-sm">
            <div className="mb-4"><span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 48, color: "var(--color-muted)" }}>search_off</span></div>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-amber-100 border border-amber-200 text-spark-amber text-sm font-semibold">
          <span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 16, verticalAlign: "middle", marginRight: 4 }}>wb_sunny</span>Free quotes, no pressure
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {interestOptions.map((opt) => {
              ...
              return (
                ...
                >
                  <span aria-hidden="true" translate="no" className="material-symbols-outlined" style={{ fontSize: 24 }}>{opt.icon}</span>
